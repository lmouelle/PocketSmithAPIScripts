...
| sed 's/Merchant/Description/1' | sed 's/Memo/Original Description/1' | sed 's/Note/Notes/1' | sed 's/Account/Account Name/1' | cut -d\` -f1,2,4,6,7,9,11,12,13 | awk -F \` -v OFS='`' '{print $1,$2,$8,$3,$4,$6,$5,$7,$9}'
